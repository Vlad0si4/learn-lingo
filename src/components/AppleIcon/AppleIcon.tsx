...
export const AppleIcon: FC<AppleIconProps> = ({ status }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="47" height="57" viewBox="0 0 47 57" fill="none">
      ...
      />
      <path
        d="M45.6392 43.742C44.8124 45.6909 43.8338 47.4849 42.7 49.1342C41.1545 51.3829 39.8891 52.9391 38.9139 53.8034C37.4021 55.2221 35.7824 55.9487 34.0479 55.9901C32.8027 55.9901 31.3011 55.6284 29.5531 54.895C27.7994 54.1651 26.1877 53.8034 24.7141 53.8034C23.1686 53.8034 21.5111 54.1651 19.7381 54.895C17.9625 55.6284 16.532 56.0107 15.4384 56.0486C13.7751 56.1209 12.1172 55.3736 10.4624 53.8034C9.40616 52.8634 8.08505 51.252 6.50243 48.9689C4.80439 46.5312 3.40838 43.7041 2.31471 40.4812C1.14343 36.9998 0.556274 33.6288 0.556274 30.3651C0.556274 26.6267 1.34792 23.4023 2.93359 20.7004C4.17978 18.5299 5.83765 16.818 7.91262 15.5612C9.98758 14.3043 12.2296 13.6639 14.644 13.6229C15.9651 13.6229 17.6976 14.0399 19.8505 14.8593C21.9973 15.6816 23.3758 16.0985 23.9802 16.0985C24.432 16.0985 25.9633 15.6111 28.5593 14.6389C31.0142 13.7376 33.0862 13.3643 34.7835 13.5113C39.3829 13.89 42.8384 15.7401 45.1364 19.0735C41.0229 21.6167 38.9881 25.1788 39.0286 29.7484C39.0657 33.3079 40.3311 36.2699 42.8181 38.6216C43.9452 39.7132 45.2039 40.5568 46.6043 41.156C46.3006 42.0547 45.98 42.9156 45.6392 43.742Z"
        fill={`url(#${status})`}
      />
      <defs>
        <linearGradient id="themaA" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#FBE9BA" />
          <stop offset="100%" stopColor="#E7C885" />
        </linearGradient>
        <linearGradient id="themaB" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#CBDED3" />
          <stop offset="100%" stopColor="#9EB9AD" />
        </linearGradient>
        <linearGradient id="themaC" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#BFD6EA" />
          <stop offset="100%" stopColor="#9FB6CD" />
        </linearGradient>
        <linearGradient id="themaD" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#F1C0BD" />
          <stop offset="100%" stopColor="#DFA299" />
        </linearGradient>
        <linearGradient id="themaF" x1="0%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#F3C8BA" />
          <stop offset="100%" stopColor="#EFA98C" />
        </linearGradient>
      </defs>
    </svg>
  );
